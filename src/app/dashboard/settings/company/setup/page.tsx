...
export default function SetupCompanyPage() {
  ...
  const [isPincodeSheetOpen, setIsPincodeSheetOpen] = useState(false);
  ...
  return (
    <>
      <div className="flex h-full min-h-screen flex-col bg-slate-50 dark:bg-background">
        ...
        <main className="flex-1 p-4 space-y-6">
          ...
          <div className="space-y-4">
              ...
              <div onClick={() => setIsPincodeSheetOpen(true)}>
                  ...
                  <div className="mt-1 relative">
                      <Input
                          ...
                          value={pincode}
                          readOnly
                          className="mt-1 bg-white dark:bg-card cursor-pointer"
                      />
                  </div>
              </div>
      ...
      <Sheet open={isPincodeSheetOpen} onOpenChange={setIsPincodeSheetOpen}>
        <SheetContent side="bottom" className="sm:max-w-sm mx-auto rounded-t-lg p-0">
          <SheetHeader className="p-4 flex flex-row items-center gap-2 border-b">
            ...
            <SheetTitle>Enter Pincode</SheetTitle>
          </SheetHeader>
          <div className="p-6">
            <Label htmlFor="sheet-pincode">Pincode</Label>
            <Input
              id="sheet-pincode"
          ...
          <SheetFooter className="grid grid-cols-2 gap-4 p-4 pt-0">
            ...
            <Button
              onClick={() => setIsPincodeSheetOpen(false)}
