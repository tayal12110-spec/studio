...
export default function LateArrivalReportPage() {
  ...
  const handleDownload = () => {
    const reportName = usePayrollCycle
      ? "Late Arrival Report (Payroll Attendance Cycle)"
      : "Late Arrival Report";

    toast({
      title: 'Downloading Report...',
      description: 'Your late arrival report is being generated.',
    });
  ...
  return (
    <div className="flex h-full min-h-screen flex-col bg-background">
      <header className="flex h-16 shrink-0 items-center border-b bg-card px-4">
        ...
        <h1 className="ml-4 text-lg font-semibold">Late Arrival Report</h1>
      </header>
