...
export default function TdsSummaryReportPage() {
  ...
  const handleDownload = () => {
    const reportName = "TDS Summary Report";
    
    toast({
      title: 'Downloading Report...',
      description: 'Your TDS summary report is being generated.',
    });
  ...
  return (
    <div className="flex h-full min-h-screen flex-col bg-background">
      <header className="flex h-16 shrink-0 items-center border-b bg-card px-4">
        ...
        <h1 className="ml-4 text-lg font-semibold">TDS Summary Report</h1>
      </header>
